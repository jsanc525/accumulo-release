            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                {
                  ...
                  _val20 = new TableInfo();
                  _val20.read(iprot);
                  struct.tableMap.put(_key19, _val20);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                TabletServerStatus _elem23;
                for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                {
                  _elem23 = new TabletServerStatus();
                  _elem23.read(iprot);
                  struct.tServerInfo.add(_elem23);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i28 = 0; _i28 < _map25.size; ++_i28)
                {
                  ...
                  _val27 = iprot.readByte();
                  struct.badTServers.put(_key26, _val27);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                for (int _i31 = 0; _i31 < _set29.size; ++_i31)
                {
                  ...
                  struct.serversShuttingDown.add(_elem30);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem33 = new DeadServer();
                  _elem33.read(iprot);
                  struct.deadTabletServers.add(_elem33);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i48 = 0; _i48 < _map45.size; ++_i48)
          {
            ...
            _val47 = new TableInfo();
            _val47.read(iprot);
            struct.tableMap.put(_key46, _val47);
          }
        }
        struct.setTableMapIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          TabletServerStatus _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = new TabletServerStatus();
            _elem50.read(iprot);
            struct.tServerInfo.add(_elem50);
          }
        }
        struct.setTServerInfoIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          for (int _i55 = 0; _i55 < _map52.size; ++_i55)
          {
            ...
            struct.badTServers.put(_key53, _val54);
          }
        }
        struct.setBadTServersIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          for (int _i58 = 0; _i58 < _set56.size; ++_i58)
          {
            ...
            struct.serversShuttingDown.add(_elem57);
          }
        }
        struct.setServersShuttingDownIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          {
            _elem60 = new DeadServer();
            _elem60.read(iprot);
            struct.deadTabletServers.add(_elem60);
          }
        }
        struct.setDeadTabletServersIsSet(true);
      }
