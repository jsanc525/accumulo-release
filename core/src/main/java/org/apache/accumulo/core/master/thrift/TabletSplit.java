            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                org.apache.accumulo.core.data.thrift.TKeyExtent _elem63;
                for (int _i64 = 0; _i64 < _list62.size; ++_i64)
                {
                  _elem63 = new org.apache.accumulo.core.data.thrift.TKeyExtent();
                  _elem63.read(iprot);
                  struct.newTablets.add(_elem63);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          org.apache.accumulo.core.data.thrift.TKeyExtent _elem68;
          for (int _i69 = 0; _i69 < _list67.size; ++_i69)
          {
            _elem68 = new org.apache.accumulo.core.data.thrift.TKeyExtent();
            _elem68.read(iprot);
            struct.newTablets.add(_elem68);
          }
        }
        struct.setNewTabletsIsSet(true);
      }
