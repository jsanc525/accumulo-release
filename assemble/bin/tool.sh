...
HTRACE4_LIB="$LIB/htrace-core4.jar"
THREADLY_LIB="$LIB/threadly.jar"
...
LIB_JARS="$THRIFT_LIB,$CORE_LIB,$FATE_LIB,$ZOOKEEPER_LIB,$TRACE_LIB,$JCOMMANDER_LIB,$COMMONS_VFS_LIB,$GUAVA_LIB,$HTRACE_LIB,$HTRACE4_LIB,$THREADLY_LIB"
H_JARS="$THRIFT_LIB:$CORE_LIB:$FATE_LIB:$ZOOKEEPER_LIB:$TRACE_LIB:$JCOMMANDER_LIB:$COMMONS_VFS_LIB:$GUAVA_LIB:$HTRACE_LIB:$HTRACE4_LIB:$THREADLY_LIB"
